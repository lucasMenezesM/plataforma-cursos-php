...
<div class="container">
    ...
    <div class="px-4 pt-5 my-5 text-center border-bottom">
        <h1 class="display-4 fw-bold text-body-emphasis"><?= isset($search) ? "Search results for: " . $search : "See all available courses" ?></h1>
    ...
    <div id="container-all-courses">
        ...
        <?php if (isset($search) && sizeof($courses) === 0): ?>
            <h3>No results for your search were found</h3>
        <?php endif ?>
